...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Listado de Puestos</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="card-body" style="display: block;">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th><center>Nombre del Puesto</center></th>
    ...
    $(function () {
        $("#example1").DataTable({
            ...
            "language": {
                ...
                "infoEmpty": "Mostrando 0 a 0 de 0 Puestos",
                "infoFiltered": "(Filtrado de _MAX_ total Puestos)",
                "infoPostFix": "",
                "thousands": ",",
