...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Detalle de la Venta <?= $nro_venta; ?> </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                        ...
                                        <table class="table table-bordered table-sm table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #e7e7e7; text-align: center">Precio costo</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center><?php echo $carrito_dato['precio_costo']; ?></center></td>
                                                    <td>
                                                        <center>
                                                            <?php
                               ...
                               <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <center><a href="<?php echo $URL;?>/app/controllers/facturas/generar_factura.php?id_venta=<?= $id_venta_get; ?>" class="btn btn-primary">Generar Factura PDF</a></center>
